...
const Footer = () => {
    return (
        <>
            <footer className="mt-8 md:py-20 py-12 relative bg-white/[0.15] backdrop-blur-lg shadow-[0_3px_45px_0px_rgba(2,24,93,0.075)]">
                <div className="relative mx-auto px-4 md:max-w-full md:px-12 lg:max-w-6xl xl:px-0 ">
                    <h2 className="md:text-[50px] text-[21px] text-center font-bold md:leading-[57px] leading-[26px] text-gray-800 w-full max-w-5xl mx-auto">
