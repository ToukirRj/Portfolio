...
function Header() {
    ...
    return (
        <header className='header fixed w-full shadow backdrop-blur-lg px-4 z-30 left-0 top-0 right-0 my-0 mx-auto h-[60px]'>
            <div className='px-4 sm:px-12 w-full xl:px-0'>
                <div className='relative flex flex-wrap items-center justify-between gap-6 lg:gap-0 py-2'>
                    ...
                    <Link to="https://wa.me/8801753778070" target="_blank" 
                        className="relative py-1 px-4 before:absolute before:inset-0 before:rounded-full before:transition-transform before:duration-300 hover:before:scale-110 before:bg-[#10b881]">
