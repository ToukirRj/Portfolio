                    ...
                    <div className='grid md:grid-cols-2 grid-cols-1 md:gap-10 gap-4 md:mx-[70px] mx-0'>
                        <div className='text-end'>
                            <div className='md:w-[65%] w-full mx-auto md:mt-[50px] mt-0 md:text-start text-center'>
                                <h2 className="md:text-[69px] text-[47px] font-bold text-[#1F2937] md:leading-[80px] leading-[50px]">My 
                                ...
                                <p className="mx-auto max-w-full mt-2 text-[#1F2937] w-full md:text-[23px] text-[19px] font-[300] leading-[37px]">
                                    Depend on customer satisfaction, Here are the services I provide
                                </p>
                            </div>
                        </div>
                        {serviceData.map(service => (
                            <div key={service.id} className="each-service backdrop-blur-lg bg-white/[.45] shadow-[0_3px_35px_0px_rgba(2,24,93,0.1)] md:rounded-[64px] rounded-[45px] overflow-hidden">
                                <div className='w-full relative'>
                                    ...
                                    <div className='relative md:p-[50px] p-[25px]'>
                                        ...
                                        <div className='gap-2 md:mt-[200px] mt-[150px]'>
