                            ...
                            <div className="lg:w-5/12 sm:1/2 w-full">
                                <div className="px-3">
                                    ...
                                    <div className="mt-6 flex justify-start">
                                        ...
                                        <Link to="https://wa.me/8801753778070" className="group h-[54px] w-auto relative overflow-hidden z-10 flex items-center rounded-full ps-6 pe-[12px] border-2 border-[#1F2937] bg-[#1F2937] text-[#FB8245] ease-in-out duration-500">
                                            ...
                                            <span className='text-[#fff] group-hover:text-[#FB8245] text-[14px] font-[500] tracking-wider uppercase'>Hire Me</span>
