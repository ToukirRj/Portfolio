                ...
                <div className="md:pt-[200px] pt-[110px] pb-12 relative z-10">
                    <div className="mx-auto px-4 md:px-12 xl:max-w-7xl xl:px-0">
                        <div className="items-center justify-center md:gap-12 gap-5 flex md:flex-row flex-col relative z-20 ">
                            ...
                            <div className="md:w-3/5 w-full sm:block flex flex-col items-center z-10 mt-2">
                                ...
                                <h1 className="my-[23px] text-[#1f2937] md:text-[55px] text-[27px] font-[700] md:leading-[64px] leading-[36px] tracking-normal md:text-start text-center">
