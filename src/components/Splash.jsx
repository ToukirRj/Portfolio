    ...
    return (
        <>
            <div className='relative z-20'>
                <section className="sm:pt-40 pb-24 relative z-10">
                    <div className="mx-auto px-4 sm:px-12 xl:max-w-7xl xl:px-0 animatable">
                        <div className="items-center justify-center sm:gap-12 gap-5 flex sm:flex-row flex-col relative z-20">
                            <div className="sm:w-2/5 w-full relative bg-[#000]/[0.05] rounded-[30px] px-[30px] pt-[30px] pb-[40px]">
                                ...
                                <div className="mt-2 border-t border-[#1F2937]/[0.2] pt-4 relative z-10">
                                    <div class="flex justify-center">
                                        <a class="group h-[50px] w-auto relative overflow-hidden z-10 flex items-center rounded-full ps-6 pe-[12px] bg-gradient-to-r from-[#13d192] to-[#13d192] text-[#FB8245] ease-in-out duration-500" href="https://wa.me/8801753778070" target="_blank">
                                            <span class="w-[38px] h-[38px] group-hover:w-[38px] group-hover:h-[38px] absolute -z-[1] left-[5px] opacity-50 group-hover:opacity-100 bg-white group-hover:bg-[#fff] rounded-full ease-in-out duration-500 btn-left"></span>
                                            <span class="text-[#0d241c] group-hover:text-[#fff] text-[15px] font-[500] tracking-normal">Let's Chat</span>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 1024 1024" className='relative ms-[12px] group-hover:ms-[12px] ease-in-out duration-500'>
                                                <path fill="#000" d="M768 256H353.6a32 32 0 1 1 0-64H800a32 32 0 0 1 32 32v448a32 32 0 0 1-64 0z"/>
                                                <path fill="#000" d="M777.344 201.344a32 32 0 0 1 45.312 45.312l-544 544a32 32 0 0 1-45.312-45.312z"/>
                                            </svg>
                                        </a>
                                    </div>
                            ...
                            <div className="sm:w-3/5 w-full sm:block flex flex-col items-center z-10 mt-3">
                                ...
                                <h1 className="my-[25px] text-[#1f2937] sm:text-[55px] text-[24px] font-[700] sm:leading-[64px] leading-[32px] tracking-normal sm:text-start text-center">
                                ...
                                <p className="text-[18px] leading-[30px] font-[300] tracking-normal text-[#1F2937] sm:text-start text-center mb-[25px]">
                        ...
                        <div className="mt-12 relative z-10">
                            <h1 className="text-[26px] font-semibold text-center tracking-tight text-[#1f2937] mb-3">Get Me Connect Now on</h1>
                            <div classname="flex justify-center">
                                <div className="flex items-center justify-center grid-cols-4 sm:space-x-5 space-x-0 sm:gap-0 gap-4 mx-auto">
                                    {socialLinksData.map(link => (
                                        <Link key={link.id} to={link.url} target={link.target}
                                            className="flex items-center space-x-3 py-4 px-5 bg-[#000]/[0.05] bg-blur rounded-xl hover:shadow-lg hover:bg-[#fff]/[0.65] transition-all">
                                            <div className="flex-shrink-0">
                                                <img className="w-12 h-12 rounded-full" src={link.imageSrc} alt={`${link.platform} logo`} />
                                            </div>
                                            <div className="min-w-0 tracking-normal">
                                                <p className="text-[17px] font-[600] text-[#1f2937]">{link.platform}</p>
                                                <p className="text-sm text-[#1f2937]">{link.role}</p>
                                            </div>
                                        </Link>
                                    ))}
                                </div>
