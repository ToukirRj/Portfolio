...
const Steps = () => {
    return (
        <>
            <div className="ms:py-20 py-6 relative z-20">
                <div className="mx-auto px-4 sm:px-12 xl:max-w-6xl xl:px-0">
                    <div className='grid md:grid-cols-2 grid-cols-1 md:gap-10 gap-4 place-items-center md:mx-[50px] mx-0'>
                        <div className="w-full relative">
                            <div className='md:w-[74%] w-full mx-auto md:mb-[50px] mb-0 md:text-end text-center'>
                        ...
                        <div className="w-full ps-10">
                            {stepsData.map(step => (
                                <div key={step.id} className="step relative z-10 w-full mt-[17px]">
                                    ...
                                    <div className="px-5 py-4 backdrop-blur-lg bg-gradient-to-t from-[#FF8045]/[0.07] to-white/[0.15] shadow-[0_3px_15px_0px_rgba(2,24,93,0.15)] rounded-l-[30px] rounded-r-[50px]">
